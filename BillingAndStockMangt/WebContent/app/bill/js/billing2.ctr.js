...
var app = angular
		.module("bill", [ "xeditable", "ui.bootstrap", "datatables" ]);
...
app.controller("billingCtr", [ '$scope', '$window', function($scope, $window)
...
app.controller("editableController2", [ '$scope', '$window',
