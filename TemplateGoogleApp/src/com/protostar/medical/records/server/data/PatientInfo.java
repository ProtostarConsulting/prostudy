...
public class PatientInfo {
	...
	public String toString() {
		...
		return "I am " + getFirstName() + " " + getLastName() + " " + getAge()
				+ " " + getOccupation() + " " + getPhone() + " "
				+ getAddressLine1() + " " + getAddressLine2() + " " + getCity()
				+ " " + getPIN() + " " + getDateofvisit() + " "
				+ getClinical_note() + " " + getInvestigation_report() + " "
				+ getProvisional_dignosis() + " " + getInvestigation_report()
				+ " " + getDigno_after_investigation() + " " + getAdvice()
				+ " " + getFollo_up() + " " + getObservation() + " "
				+ getDate();
	}
