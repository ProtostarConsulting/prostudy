...
public class PartnerSchoolService {
	...
	public PartnerSchoolEntity addPartnerSchool(
		...
		if (notificationEnabled
			...
			// Send SMS
			String smsMsg = "Thanks for participating in Gandhi Vichar Sanskar Pariksha. It’s Regd. No. is:"
					+ partnerSchoolEntity.getAutoGenerated()
					+ ".From onward, you may referred this Number on each correspondence.";
			/*
