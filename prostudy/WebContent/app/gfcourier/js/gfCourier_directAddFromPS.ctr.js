						...
						for (var i = 0; i < $scope.partnerSchool.bookSummary.bookDetail.length; i++) {
							for (var j = 0; j < $scope.bookStocks.length; j++) {
								if ($scope.partnerSchool.bookSummary.bookDetail[i].bookName == $scope.bookStocks[j].id) {
									...
									$scope.weight = + $scope.bookStocks[j].weight * $scope.partnerSchool.bookSummary.bookDetail[i].totalStud;
							...
							for (var i = 0; i < $scope.partnerSchool.bookSummary.bookDetail.length; i++) {
								for (var j = 0; j < $scope.bookStocks.length; j++) {
									if ($scope.partnerSchool.bookSummary.bookDetail[i].bookName == $scope.bookStocks[j].id) {
										...
										$scope.partnerSchoolNew.totalWeight = + $scope.bookStocks[j].weight * $scope.partnerSchool.bookSummary.bookDetail[i].totalStud;
