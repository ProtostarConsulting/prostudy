		...
		.controller(
				...
				function($scope, $window, $mdToast, $timeout, $mdSidenav,
					...
					$scope.addPartnerSchool = function() {
						...
						if ($scope.PaymentDetail.payReceivedBy !=""){
							$scope.PaymentDetailArray.push($scope.PaymentDetail);		
							$scope.partnerSchool.paymentDetail = $scope.PaymentDetailArray;
						}
			...
			$scope.calculatepaidandpending=function(){
				...
				for(i=0;i<$scope.PaymentDet.length;i++){
					...
					$scope.PaymentDetail.pAmount=$scope.bookSummary.total-$scope.PaymentDetail.tPaid;
				}
