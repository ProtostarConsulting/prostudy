angular
		...
		.controller(
				...
				function($scope, $window, $mdToast, $timeout, $mdSidenav,
					...
					var initSchoolVariablesFn = function(pSchool) {
					...
					$scope.getPSchoolByPSID = function() {
						if ($scope.partnerSchool.id) {
							initSchoolVariablesFn($scope.partnerSchool);
						} else {
							var PartnerSchoolService = appEndpointSF
									.getPartnerSchoolService();
					...
					$scope.waitForServiceLoad = function() {
						if (appEndpointSF.is_service_ready) {
							...
							if ($stateParams.selectedPSchool
									&& $stateParams.selectedPSchool.id) {
								$scope.partnerSchool = $stateParams.selectedPSchool;
