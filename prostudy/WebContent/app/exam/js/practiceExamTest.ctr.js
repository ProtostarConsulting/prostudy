		...
		.controller(
				...
				function($scope, $window, $mdToast, $timeout, $mdSidenav,
					...
					$scope.checkAnswer = function() {
						...
						$state.go("exam.practiceExamResultView");
						...
						PracticeExamService
								...
								.then(
										function(msgBean) {
											...
											$log.debug("Ans :"+$scope.userAnsList);
								...
								.then(
										function(practiceTest) {
											...
											$scope.buttonLimit = function(count) {
												$scope.totalPages = Math.ceil($scope.Test.questions.length / 4);
												
												return Array.apply(0,Array(+count)).map(
														function(value, index) {
															return index;
														});
												//$log.debug("Pages :"+ $scope.Test.questions.length);
											}// end of buttonlimit
