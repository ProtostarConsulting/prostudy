angular
		...
		.controller(
				...
				[
						...
						function($scope, $window, $mdToast, $q, appEndpointSF) {
							console.log("Inside examCtr");

							$scope.showSimpleToast = function() {
								$mdToast.show($mdToast.simple().content(
										'Exam Saved!').position("top")
										.hideDelay(3000));
							...
							$scope.submitButton = function(option, qId) {
								...
								gapi.client.examService
										.addExam($scope.exam)
										.execute(
												function(resp) {

													console
															.log("Exam Saved Successfully : "
																	+ resp.msg);

													console.log("Exam Entity: "
															+ $scope.exam);
													console
															.log("Student Name: "
							...
							$scope.getQuestionList = function() {
								...
								//console.log("appEndpointSF.getExamService():"+ appEndpointSF.getExamService());
